...
// Использует старую систему ввода Unity. В настройках нужно в ручную выставить Input System на старую систему(Old) или на двойную систему(Both) (но есть возможность багов, делай на свой страх и риск (:D) )
// работает через Rigidbody, для прыжка нужна поверхность с маской, а у персонажа, в самой нижней части, чуть выше от земли, пустышка()
